...
\title{Projeto de cabeamento estruturado para Unidade de Saúde}					% Title of your article goes here
...
%% ====================================
%% ====================================
\initial{E}\textbf{ste projeto tem como propósito a estruturação de cabos e equipamentos da nova Unidade de Saúde da cidade de Pato Bragado, como é um local novo, não existe nenhuma estrutura de rede. Neste projeto serão apresentadas as plantas físicas do prédio e do datacenter, a elaboração da planta lógica, todos os equipamentos de rede que serão usado e o levantamento de quantidade/custo total do projeto. Dentre as atividades que serão executadas estão: Montagem e organização de rack para estruturamento de switches e cabos, instalação de cabos de redes nas salas para uso dos equipamentos e instalação dos próprios equipamentos que usarão a rede.}
...
Atualmente nenhum usuário está utilizando os recursos de rede, pois, o prédio é uma construção nova. Futuramente serão construídas novas instalações no mesmo lote do prédio que deverão utilizar os mesmos recursos de rede.
...
\subsection{Usuários}
Serão aproximadamente vinte e cinco usuários, que utilizarão equipamentos como: computadores, notebooks, impressoras e cartão-ponto.

Crie uma relação da quantidade, perfil de usuários de seu projeto.

\subsection{Aplicativos}
Os aplicativos que serão utilizados com maior frequência são: O sistema geral da de atendimento da Unidade de Saúde que necessita um quantidade mínima de banda de internet para perfeito funcionamento(sistema web). Já o cartão ponto, o sistema de compras e almoxarifado e as impressoras necessitam apenas de rede para funcionamento.
